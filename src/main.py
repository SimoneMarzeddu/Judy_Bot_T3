import json
import time
from src.secret_passage_modules import HiddenRoom, HiddenCorridor
from src.reach_modules import Gold, Unseen, Horizon
from src.general_modules import Pray, Elbereth, Run, Break, Fight, Eat, StairsDescent, StairsAscent, ExploreClosest
from src.core import GameWhisperer, DungeonWalker, main_logic
...
if __name__=="__main__":
    dungeon_walker, game, logic, task_map, attempts = start_bot("config/config.json")
